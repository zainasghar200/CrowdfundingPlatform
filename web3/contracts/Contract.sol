...
contract CrowdFunding {
    ...
    function  donateToCampaign(uint256 _id) public payable{
        ...
        (bool sent,) = payable(campaign.owner).call{value: amount}("");// comma represent something can also comeafter sent

        if(sent) {
          campaign.annountCollected = campaign.annountCollected + amount;  
        }
    }
